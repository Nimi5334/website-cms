...
export const LABELS = {
  ...
  open_title: "כניסה לעריכת האתר",
  open_sub: "התחברו כדי לערוך את האתר שלכם.",
  password: "סיסמה",
  email: "אימייל",
  signin: "כניסה",
  signup: "הרשמה",
  signup_sub: "צרו חשבון כדי להתחיל לערוך את האתר שלכם.",
  have_account: "כבר יש לכם חשבון? התחברות",
  no_account: "אין לכם חשבון? הרשמה",
  save: "שמירת טיוטה",
  saving: "שומר…",
